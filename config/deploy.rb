...
set :deploy_to, '/home/rb/work/pgate_radmin'
set :repository, 'git://github.com/solo123/pgate_radmin.git'
set :branch, 'deploy'
...
task :pull => :environment do
  ...
  queue  %{ln -s /home/rb/work/puma/pgate_radmin.rb config/puma.rb}
